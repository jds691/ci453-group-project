...
(function () {
  ...
  */
  ...
  $(function () {
    var words = ['cyber', 'security', 'data', 'computer', 'password', 'network', 'hacker', 'malware', 'threat', 'virus', 'internet', 'attack',
   'phishing', 'deepfake', 'bias', 'automate', 'detect', 'vulnerability', 'scan', 'systems', 'code', 'bypass'];
